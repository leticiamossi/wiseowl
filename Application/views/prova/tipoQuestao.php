...
<body>
    ...
    <main class="fundo-roxo">
        <div class="caixa caixa-center">
            ...
            <a href="/prova/banco" class="btn-a">
                <div class="btn-main">
                    <div class="btn-icon">
                    ...
                    <div class="btn-body btn-body-w300">
                        <p>Banco de Questões</p>
                    </div>
                </div>
            </a>
            <a href="/prova/personalizada" class="btn-a">
                <div class="btn-main">
                    <div class="btn-icon">
            ...
            <a href="/prova/descritiva" class="btn-a">
                <div class="btn-main">
                    <div class="btn-icon">
