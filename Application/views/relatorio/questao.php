...
<body onload="carregar()">
    ...
    <main class="fundo-roxo">
        <div class="caixa">
            ...
            <div id="opcoes-resposta" style="width: 90%; margin: 10px auto">
            <h3 class="titulo-main">Respostas</h3>
            </div>
        ...
        <script src="../../public/assets/js/relatorios/relatorioQuestao.js"></script>
    </main>
