...
<body onload="carregar()">
    ...
    <main class="fundo-roxo">
        <div class="caixa">
            <h3 class="titulo-main">Relatório da Prova</h3>
            ...
            <div class="numeros-relatorio">
                <div id="menor-nota" class="cartao-relatorio"></div>
                <div id="media" class="cartao-relatorio"></div>
                <div id="maior-nota" class="cartao-relatorio"></div>
            </div>

            <div style="display: flex; flex-direction: row; flex-wrap: wrap; justify-content: center; width: 90%; margin: 70px auto; gap: 40px">
                <div id="distribuicao-nota"></div>
