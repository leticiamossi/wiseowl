...
<body>
    ...
    <main class="fundo-roxo">
        <div class="caixa caixa-center">
            ...
            <p style="width: 90%; text-align: center">Para garantir a precisão, revise cuidadosamente as questões geradas pela IA: verifique se estão corretas, bem formuladas e adequadas ao conteúdo desejado antes de utilizá-las.</p>
            <form action="/cadastro/extra/ia/<?php echo $data['id']?>" enctype="multipart/form-data" method="POST"">
                ...
                <div class="inp inp-row">
                    ...
                    <select name="correta" id="correta">
                        <option selected><?php echo $data['correta']?></option>
                        <option>a</option>
                        <option>b</option>
                        <option>c</option>
                        <option>d</option>
