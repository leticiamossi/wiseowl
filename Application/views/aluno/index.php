...
<body onload="filtrar()">
    ...
    <main class="fundo-roxo">
        <div class="caixa">
            <a href="/professor/disciplina" class="btn-a">
                <div class="btn-main">
                    <div class="btn-icon">
                        <svg class="icon-roxo" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-ui-checks" viewBox="0 0 16 16">
